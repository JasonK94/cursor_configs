...
if [ -f "$README_TEMPLATE_PATH" ] && [ ! -f "$README_DEST_PATH" ]; then
    cp "$README_TEMPLATE_PATH" "$README_DEST_PATH"
fi
if [ -f "$README_KOREAN_TEMPLATE_PATH" ] && [ ! -f "$README_KOREAN_DEST_PATH" ]; then
    cp "$README_KOREAN_TEMPLATE_PATH" "$README_KOREAN_DEST_PATH"
fi
